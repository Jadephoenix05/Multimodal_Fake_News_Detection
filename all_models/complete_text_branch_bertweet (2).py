...
torch.save(
    ...
    "/kaggle/working/train_text_features.pt"
)

torch.save(
    {"features": val_features, "labels": val_labels},
    "/kaggle/working/val_text_features.pt"
)

torch.save(
    {"features": test_features, "labels": test_labels},
    "/kaggle/working/test_text_features.pt"
)
...
torch.save(
    model.state_dict(),
    "/kaggle/working/bertweet_fake_news_model.pt"
)
...
print("\n========== SAVED FILES ==========")
print("/kaggle/working/train_text_features.pt")
print("/kaggle/working/val_text_features.pt")
print("/kaggle/working/test_text_features.pt")
print("/kaggle/working/bertweet_fake_news_model.pt")
