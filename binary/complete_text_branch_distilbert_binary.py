# ============================================================
# COMPLETE TEXT BRANCH - DistilBERT
...
# 3. Loads DistilBERT (distilbert-base-uncased)
# 4. Fine-tunes DistilBERT for Fake/Real classification
...
distilbert_encoder = AutoModel.from_pretrained("distilbert-base-uncased")
distilbert_encoder = distilbert_encoder.to(device)
...
# ============================================================
# 12. DEFINE DistilBERT FAKE/REAL CLASSIFIER
# ============================================================
...
model = DistilBertFakeNewsClassifier(distilbert_encoder, NUM_CLASSES).to(device)
...
# ============================================================
# We fine-tune the complete DistilBERT encoder, mirroring the
...
#
# Text -> DistilBERT -> 768-dimensional [CLS] feature vector
#
...
torch.save(
    ...
    "/kaggle/working/train_text_features_distilbert_binary.pt"
)

torch.save(
    {"features": val_features, "labels": val_labels},
    "/kaggle/working/val_text_features_distilbert_binary.pt"
)

torch.save(
    {"features": test_features, "labels": test_labels},
    "/kaggle/working/test_text_features_distilbert_binary.pt"
)
...
torch.save(
    model.state_dict(),
    "/kaggle/working/distilbert_fake_news_model_binary.pt"
)

print("Trained DistilBERT model saved successfully!")
...
print("\n========== SAVED FILES ==========")
print("/kaggle/working/train_text_features_distilbert_binary.pt")
print("/kaggle/working/val_text_features_distilbert_binary.pt")
print("/kaggle/working/test_text_features_distilbert_binary.pt")
print("/kaggle/working/distilbert_fake_news_model_binary.pt")
